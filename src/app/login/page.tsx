...
export default function LoginPage() {
  ...
  }, [currentUser, family, authLoading, router]);
  ...
  return (
    <div className="min-h-screen bg-background-light flex flex-col">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 right-0 w-64 h-64 bg-primary-green-bright/10 rounded-full blur-3xl translate-x-1/2 -translate-y-1/2" />
        <div className="absolute bottom-0 left-0 w-48 h-48 bg-primary-green-bright/10 rounded-full blur-3xl -translate-x-1/2 translate-y-1/2" />
      </div>
      ...
      <div className="flex-1 px-6 py-8 relative z-10">
        ...
        >
          ...
          <div className="flex justify-center mb-6">
            <div className="w-16 h-16 bg-gradient-to-br from-primary-green-bright to-primary-green rounded-full flex items-center justify-center shadow-button-green">
          ...
          <p className="text-text-muted text-center mb-8">
            Entre na sua conta para acessar seu ninho
          </p>
      ...
      <div className="p-6 text-center safe-area-bottom">
        <p className="text-text-muted text-sm">
          Não tem uma conta?{' '}
          <Link href="/register" className="text-primary-orange font-medium hover:underline">
            Criar conta
          </Link>
        </p>
      </div>
